...
namespace Koniec.KsiazkiDataSetTableAdapters {
    ...
    public partial class KategorieTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Kategorie] ([IDKategorii], [Kategoria]) VALUES (@IDKategorii, " +
                "@Kategoria);\r\nSELECT IDKategorii, Kategoria FROM Kategorie WHERE (IDKategorii = " +
                "@IDKategorii)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Kategorie] SET [IDKategorii] = @IDKategorii, [Kategoria] = @Kategor" +
                "ia WHERE (([IDKategorii] = @Original_IDKategorii) AND ([Kategoria] = @Original_K" +
                "ategoria));\r\nSELECT IDKategorii, Kategoria FROM Kategorie WHERE (IDKategorii = @" +
                "IDKategorii)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Koniec.Properties.Settings.Default.KsiazkiConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IDKategorii, Kategoria FROM dbo.Kategorie";
        ...
        public virtual int Fill(KsiazkiDataSet.KategorieDataTable dataTable) {
        ...
        public virtual KsiazkiDataSet.KategorieDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            KsiazkiDataSet.KategorieDataTable dataTable = new KsiazkiDataSet.KategorieDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(KsiazkiDataSet.KategorieDataTable dataTable) {
